...
P["dj-dollar-bill"] = dict(
    ...
    intro="Seit rund 20 Jahren gestalte ich für DJ DOLLAR BILL alle Eventlayouts für seine Hip-Hop-Veranstaltungen in Clubs in Bayern und teilweise deutschlandweit. Dazu gehören Plakate, Flyer, Eintrittskarten und Bauzaunbanner, die einen einheitlichen, kreativen Look haben und die Events professionell präsentieren. Die Arbeit umfasst sowohl die grafische Gestaltung als auch die Umsetzung der Werbemittel, sodass die Marke DJ DOLLAR BILL bei Fans, Partnern und Veranstaltern einen hohen Wiedererkennungswert hat.",
...
P["rupprecht-kappl"] = dict(
    ...
    intro="Seit über 10 Jahren betreue ich die Rupprecht & Kappl GmbH und ihre verschiedenen Marken. Logos wurden überarbeitet und ein einheitliches Design für unterschiedliche Geschäftsbereiche entwickelt. Ich gestalte alle Drucksachen und Layouts sowie diverse Werbemittel für RK Immobilienmakler und die Bereiche Freizeit und Gastronomie, sodass die unterschiedlichen Unternehmen professionell und konsistent auftreten.",
...
P["sezayi-er"] = dict(
    ...
    intro="Seit 13 Jahren begleite ich SEZAYI ER in allen grafischen Belangen. Die langjährige Zusammenarbeit ermöglicht es, Projekte für die beiden Geschäftsbereiche – Telekom Shops und Tiny Houses – individuell umzusetzen: von der Gestaltung bis zu den passenden Drucksachen.",
...
P["caraservice"] = dict(
    ...
    intro="Für die CaraService Holding GmbH, ein führendes Unternehmen im Caravan Service, startet eine Zusammenarbeit mit mehreren gemeinsamen Projekten. Dazu gehört ein komplettes Messepaket mit Drucksachen und Werbemitteln, bestehend aus DIN-lang Produktflyern, Gutscheinen, Postkarten, verschiedenen Roll-Ups und Square-Flags für Messen und Events. Durch individuelle Layouts, hochwertige Druckproduktion und abgestimmte Werbetechnik entsteht ein einheitlicher Markenauftritt. Das Paket ermöglicht es den Standorten in Berlin, Düsseldorf, Weißenhorn und Rott am Inn, sich durchgängig und professionell bei Kunden und Branchenveranstaltungen zu repräsentieren.",
...
P["nele-und-hannes-ocik"] = dict(
    ...
    intro="Seit 2018 unterstütze ich Nele Ocik, bekannte Sportmoderatorin bei Sky, mit Personal Branding und digitaler Präsenz, einschließlich Briefpapier, Visitenkarten und Homepage-Gestaltung. Für Hannes Ocik, Spitzensportler, mehrfach ausgezeichneter Ruderer und Olympia-Silbermedaillengewinner, wurde 2024 eine neue Homepage konzipiert. Beide Projekte zeigen hochwertige Lösungen für Personenmarken – von klassischer Geschäftsausstattung bis zur digitalen Präsentation.",
...
P["voit"] = dict(
    ...
    intro="Seit 2011 betreue ich den Partyservice & das Eventcatering VOIT umfassend in allen grafischen Belangen – für Metzgerei, Imbiss und Catering in Weiden. Dazu gehören die Gestaltung von Drucksachen wie Aufklebern, Fahrzeugbeklebungen, Flyern, Plakaten und Foldern ebenso wie Social-Media-Grafiken, Geschäftsausstattung und ein durchgängiges Branding. So entsteht über alle Kanäle hinweg ein konsistenter, professioneller Markenauftritt.",
...
P["12ender"] = dict(
    ...
    intro="Für die beiden „12Ender“-Imbisse unterstütze ich die beiden Gastronomie-Betriebe beim Branding, grafisch sowie bei der Beschilderung innen und außen. Die Imbisse bieten von Frühstück über wechselnde warme Mittagsgerichte frische, bayerische Mahlzeiten an – und werden durch ein stimmiges Design und die passende Werbetechnik optimal sichtbar und wiedererkennbar.",
