...
'''
    ...
    subs = [
     ...
     ('<title>Marketing fürs Handwerk | Werbeagentur DESIGNJ aus Weiden</title>', f'<title>{cfg["title"]}</title>'),
     ('<meta property="og:title" content="Marketing fürs Handwerk | Werbeagentur DESIGNJ aus Weiden">', f'<meta property="og:title" content="{cfg["title"]}">'),
     ('content="Marketing fürs Handwerk aus Weiden: Website, Fahrzeug, Schilder &amp; Social Media aus einer Hand – damit dich die richtigen Kunden und Mitarbeiter finden.">', f'content="{cfg["desc"]}">'),
...
STEPS_GEN = [("Kennenlernen","Du erzählst mir kurz, wo du stehst und wo der Schuh drückt – per Telefon, WhatsApp oder <a href=\"kontakt.html\">Kontaktformular</a>. Unverbindlich und ohne Verkaufsgespräch."),
...
immo = dict(file="immobilienmarketing.html", bodyclass="kampagne-immo", slug="immobilienmarketing",
 title="Immobilienmarketing | Werbeagentur DESIGNJ aus Weiden",
 ...
 intro_ps=[
  'Gute Objekte verkaufen sich fast von allein – wenn die Präsentation stimmt. Handy-Fotos, Exposés von der Stange und eine lieblose Website lassen selbst Top-Immobilien kleiner wirken, als sie sind. Genau hier setzt <strong>Immobilienmarketing</strong> an: professionelle Exposés, eine überzeugende <a href="leistungen.html#web">Website</a> und ein einheitlicher Auftritt, der Wert zeigt.',
  'Als deine Werbeagentur für Weiden und die Oberpfalz übernehme ich das komplett – von der <a href="leistungen.html#branding">Marke</a> über Foto und Video bis zu <a href="leistungen.html#social">Social Media</a>. Du bist Profi für Immobilien, nicht fürs Marketing. Ein Ansprechpartner, alles aus einer Hand, ohne Agentur-Overhead.',
 ...
 leistungen=[
  ("Exposés &amp; Objekt-Präsentation",'Hochwertige Exposés, Objektbroschüren und Verkaufsunterlagen – so <a href="leistungen.html#branding">gestaltet</a>, dass dein Objekt im besten Licht steht. Digital und gedruckt, aus einem Guss.'),
  ("Immobilien-Website &amp; Portale",'Eine überzeugende <a href="leistungen.html#web">Website</a> mit Objektübersicht, Landingpages für Projekte und saubere Darstellung auf den Portalen – inkl. Texten und SEO-Grundlagen, damit du gefunden wirst.'),
  ...
  ("Social Media &amp; Reels",'Redaktionsplan, Objekt-Posts, Reels und laufende <a href="leistungen.html#social">Betreuung</a> bei Instagram, Facebook &amp; LinkedIn. Neue Objekte und dein Büro bleiben sichtbar.'),
  ("Großformat &amp; Vor-Ort",'Bautafel, Verkaufsschild, Bauzaunbanner und Roll-up – <a href="leistungen.html#print">Druck und Werbetechnik</a> koordiniert. Sichtbar direkt am Objekt, ohne Stress dazwischen.'),
  ("Projekt- &amp; Neubau-Vermarktung",'Für Neubau, Quartier oder Tag der offenen Tür: eine <a href="leistungen.html#marketing">Kampagne</a>, die über Print, Social und vor Ort funktioniert – statt Einzelmaßnahmen ohne roten Faden.'),
 ...
 lokal_ps=[
  ...
  'Wie das aussieht, siehst du bei meinen <a href="projekte.html">Referenzen</a>. Egal ob einzelnes Objekt oder kompletter Auftritt – wir finden den Weg, der zu dir und deinem Budget passt.'],
...
kanz = dict(file="kanzleimarketing.html", bodyclass="kampagne-kanzlei", slug="kanzleimarketing",
 title="Kanzleimarketing | Werbeagentur DESIGNJ aus Weiden",
 ...
 intro_ps=[
  'Fachlich ist deine Kanzlei top – nur sieht man das online oft nicht. Mandanten und Bewerber googeln zuerst; wer nur eine veraltete Seite findet, ist schnell bei der Konkurrenz. Genau hier setzt <strong>Kanzleimarketing</strong> an: ein seriöser, einheitlicher Auftritt und eine moderne <a href="leistungen.html#web">Website</a>, die Vertrauen schafft.',
  'Als deine Werbeagentur für Weiden und die Oberpfalz übernehme ich das komplett – von der <a href="leistungen.html#branding">Marke</a> über Content zu Fachthemen bis zu <a href="leistungen.html#social">Social Media und LinkedIn</a>. Du berätst deine Mandanten, ich kümmere mich um deinen Auftritt. Ein Ansprechpartner, alles aus einer Hand.',
 ...
 leistungen=[
  ("Kanzlei-Auftritt &amp; Design",'Logo, Geschäftsausstattung, Briefbogen und Vorlagen – ein einheitliches, <a href="leistungen.html#branding">seriöses Erscheinungsbild</a> über alle Dokumente und Kanäle.'),
  ("Kanzlei-Website &amp; Auffindbarkeit",'Eine moderne <a href="leistungen.html#web">Website</a> mit sauberen SEO-Grundlagen, damit Mandanten dich finden – inkl. Texten, die Vertrauen schaffen statt Juristendeutsch.'),
  ...
  ("Social Media &amp; LinkedIn",'Redaktionsplan, Beiträge und <a href="leistungen.html#social">Betreuung</a> – gerade LinkedIn ist für Kanzleien Gold wert. Du musst nicht selbst posten, ich halte deinen Auftritt am Leben.'),
  ...
  ("Print &amp; Kanzlei-Material",'Broschüren, Mandantenmappen, Visitenkarten und Kanzleischilder – <a href="leistungen.html#print">Druck und Abwicklung</a> koordiniert, du bekommst das fertige Ergebnis.'),
  ("Beratung &amp; laufende Betreuung",'Manchmal fehlt nicht die Umsetzung, sondern der Plan. Ich bringe Struktur in dein <a href="leistungen.html#marketing">Kanzlei-Marketing</a> und bin der Ansprechpartner übers Jahr.')],
 ...
 lokal_ps=[
  ...
  'Wie das aussieht, siehst du bei meinen <a href="projekte.html">Referenzen</a>. Egal ob kompletter Relaunch oder behutsame Auffrischung – wir finden den Weg, der zu deiner Kanzlei und deinem Budget passt.'],
...
ges = dict(file="praxismarketing.html", bodyclass="kampagne-gesundheit", slug="praxismarketing",
 title="Praxismarketing | Werbeagentur DESIGNJ aus Weiden",
 ...
 intro_ps=[
  'Deine Arbeit ist wichtig – dein Auftritt sollte es auch sein. Patienten suchen ihre Praxis heute zuerst online, und Fachkräfte schauen genau hin, für wen sie arbeiten wollen. Wer nur eine veraltete Seite hat, verliert beide. Genau hier setzt <strong>Praxismarketing</strong> an: eine moderne <a href="leistungen.html#web">Website</a> und ein einheitlicher, vertrauensvoller Auftritt.',
  'Als deine Werbeagentur für Weiden und die Oberpfalz übernehme ich das komplett – von der <a href="leistungen.html#branding">Praxis-Marke</a> über Patienten-Infos bis zu <a href="leistungen.html#social">Social Media</a> und Recruiting. Du kümmerst dich um Patienten, ich um deinen Auftritt. Ein Ansprechpartner, alles aus einer Hand.',
 ...
 leistungen=[
  ("Praxis-Website &amp; Auffindbarkeit",'Eine moderne <a href="leistungen.html#web">Website</a> mit Online-Terminen, sauberen SEO-Grundlagen und verständlichen Texten. Damit Patienten dich finden – und nicht die Praxis nebenan.'),
  ...
  ("Praxis-Design &amp; Ausstattung",'Logo, Praxisschilder, Leitsystem, Formulare und Ausstattung – ein einheitlicher, <a href="leistungen.html#branding">moderner Auftritt</a> vom Empfang bis zum Wartezimmer.'),
  ("Social Media &amp; Patienten-Infos",'Redaktionsplan, Beiträge und <a href="leistungen.html#social">Betreuung</a> bei Instagram &amp; Facebook. Öffnungszeiten, Team und Leistungen – deine Praxis bleibt sichtbar und nahbar.'),
  ...
  ("Print &amp; Praxis-Material",'Flyer, Terminkarten, Aufklärungsbögen und Praxisschilder – <a href="leistungen.html#print">Druck und Abwicklung</a> koordiniert, du bekommst das fertige Ergebnis.'),
  ("Beratung &amp; laufende Betreuung",'Manchmal fehlt nicht die Umsetzung, sondern der Plan. Ich bringe Struktur in dein <a href="leistungen.html#marketing">Praxis-Marketing</a> und bin der Ansprechpartner übers Jahr.')],
 ...
 lokal_ps=[
  ...
  'Wie das aussieht, siehst du bei meinen <a href="projekte.html">Referenzen</a>. Egal ob kompletter Relaunch oder behutsame Auffrischung – wir finden den Weg, der zu deiner Praxis und deinem Budget passt.'],
